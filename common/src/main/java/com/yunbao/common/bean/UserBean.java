...
public class UserBean implements Parcelable {
    ...
    protected Car car;
    protected String lively;
    protected String aidou;
    protected String leiji_aidou;
    protected String dstt;
    ...
    public String getLeiji_aidou() {
        return leiji_aidou;
    }

    public void setLeiji_aidou(String leiji_aidou) {
        this.leiji_aidou = leiji_aidou;
    }
    ...
    protected UserBean(Parcel in) {
        ...
        this.lively = in.readString();
        this.aidou = in.readString();
        this.dstt = in.readString();
        this.leiji_aidou = in.readString();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.lively);
        dest.writeString(this.aidou);
        dest.writeString(this.dstt);
        dest.writeString(this.leiji_aidou);
