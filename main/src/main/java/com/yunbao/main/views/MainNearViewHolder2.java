...
public class MainNearViewHolder2 extends AbsMainHomeParentViewHolder {

    private MainNearNearViewHolder mNearViewHolder;

    public MainNearViewHolder2(Context context, ViewGroup parentView) {
        super(context, parentView);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.view_main_near2;
    }
