...
public class VideoCommentViewHolder extends AbsViewHolder implements View.OnClickListener, OnItemClickListener<VideoCommentBean>, VideoCommentAdapter.ActionListener {
    ...
    public VideoCommentViewHolder(Fragment fragment, ViewGroup parentView) {
        super(fragment.getContext(), parentView);
        mFragment=fragment;
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.root || i == R.id.btn_close) {
            ...
            if (!TextUtils.isEmpty(mVideoId) && !TextUtils.isEmpty(mVideoUid)) {
                if (mFragment!=null){
                    ((VideoPlayFragment) mFragment).openCommentInputWindow(false, mVideoId, mVideoUid, null);
                }else{
            ...
            if (!TextUtils.isEmpty(mVideoId) && !TextUtils.isEmpty(mVideoUid)) {
                if (mFragment!=null){
                    ((VideoPlayFragment) mFragment).openCommentInputWindow(true, mVideoId, mVideoUid, null);
                }else{
    ...
    public void onItemClick(VideoCommentBean bean, int position) {
        if (!TextUtils.isEmpty(mVideoId) && !TextUtils.isEmpty(mVideoUid)) {
            if (mFragment!=null){
                ((VideoPlayFragment) mFragment).openCommentInputWindow(false, mVideoId, mVideoUid, bean);
            }else{
