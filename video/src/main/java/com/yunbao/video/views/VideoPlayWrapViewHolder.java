...
public class VideoPlayWrapViewHolder extends AbsViewHolder implements View.OnClickListener {
    ...
    public VideoPlayWrapViewHolder(Fragment fragment, ViewGroup parentView) {
    ...
    private void clickComment() {
        if (mContext instanceof AbsVideoPlayActivity){
            ...
            ((VideoPlayFragment) mFragment).openCommentWindow(mVideoBean.getId(), mVideoBean.getUid());
        }
    }
    ...
    private void clickShare() {
        ...
        if (mContext instanceof AbsVideoPlayActivity){
            ...
            fragment.show(mFragment.getFragmentManager(), "VideoShareDialogFragment");
        }
    }
